...
public class InsertAI : BaseNetLogic
{
[ExportMethod]
    public void InsertEntries()
    {
        try
        {
            string ExcelPathVariable = LogicObject.GetVariable("AI").Value;
            ...
            if (sheet != null)
            {
                int rowCount = 11;//sheet.LastRowNum; // This may not be valid row count.
                ...
                var table = internalDatabase.Tables.Get<FTOptix.Store.Table>("AI");
