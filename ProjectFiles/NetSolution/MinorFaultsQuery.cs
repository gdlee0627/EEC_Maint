...
public class MinorFaultsQuery : BaseNetLogic
{
[ExportMethod]
    public void RunQuery()
    {
        ...
        string queryState = String.Format("SELECT * FROM MinorFaults WHERE FaultType={0} AND FaultCode={1} ORDER BY FaultType",FaultTypeInput,FaultCodeInput);
