...
public class InsertAO : BaseNetLogic
{
[ExportMethod]
    public void InsertEntries()
    {
        try
        {
            string ExcelPathVariable = LogicObject.GetVariable("AO").Value;
            ...
            if (sheet != null)
            {
                int rowCount = 5;//sheet.LastRowNum; // This may not be valid row count.
                ...
                var table = internalDatabase.Tables.Get<FTOptix.Store.Table>("AO");
