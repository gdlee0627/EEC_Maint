...
#endregion
public class InsertComm : BaseNetLogic
{
[ExportMethod]
    public void InsertEntries()
    {
        try
        {
            string ExcelPathVariable = LogicObject.GetVariable("Communication").Value;
            ...
            if (sheet != null)
            {
                int rowCount = 13;//sheet.LastRowNum; // This may not be valid row count.
                ...
                var table = internalDatabase.Tables.Get<FTOptix.Store.Table>("Communication");
