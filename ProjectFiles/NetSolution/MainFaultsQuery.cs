...
public class MainFaultsQuery : BaseNetLogic
{
[ExportMethod]
    public void RunQuery()
    {
        ...
        string queryState = String.Format("SELECT * FROM MajorFaults WHERE FaultType={0} AND FaultCode={1} ORDER BY FaultType",FaultTypeInput,FaultCodeInput);
