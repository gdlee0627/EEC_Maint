...
public class InsertDO : BaseNetLogic
{
[ExportMethod]
    public void InsertEntries()
    {
        try
        {
            string ExcelPathVariable = LogicObject.GetVariable("DO").Value;
            ...
            if (sheet != null)
            {
                int rowCount = 22;//sheet.LastRowNum; // This may not be valid row count.
