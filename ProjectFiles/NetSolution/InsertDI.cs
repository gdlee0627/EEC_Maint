...
public class InsertDI : BaseNetLogic
{
[ExportMethod]
    public void InsertEntries()
    {
        try
        {
            string ExcelPathVariable = LogicObject.GetVariable("DI").Value;
            ...
            if (sheet != null)
            {
                ...
                var table = internalDatabase.Tables.Get<FTOptix.Store.Table>("DI");
