...
public class InsertController : BaseNetLogic
{
...
[ExportMethod]
    public void InsertEntries()
    {
        try
        {
            string ExcelPathVariable = LogicObject.GetVariable("Controller").Value;
            ...
            if (sheet != null)
            {
                int rowCount = 19;//sheet.LastRowNum; // This may not be valid row count.
                ...
                var table = internalDatabase.Tables.Get<FTOptix.Store.Table>("Controller");
